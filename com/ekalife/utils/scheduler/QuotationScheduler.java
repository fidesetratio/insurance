...
/**
 * @spring.bean Class ini untuk memberikan informasi tentang Event yang akan dilakukan berdasarkan E-MNC
 * 
 * @author Anta
 * @since 
 */

public class QuotationScheduler extends ParentScheduler{
	//main method
