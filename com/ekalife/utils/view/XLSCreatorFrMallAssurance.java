...
public class XLSCreatorFrMallAssurance {

	//@Override
	public void buildExcelDocument(String fileName, String dirFileName, List<Pas> reportFrMallAssurance, Date yesterday) throws Exception {
		...
		firstHeaderCellh0.setCellValue(new HSSFRichTextString("Follow Up Further Requirement PAS MallAssurance"));
		...
		firstHeaderCell1.setCellValue(new HSSFRichTextString("No.Kartu"));
		firstHeaderCell2.setCellValue(new HSSFRichTextString("Nama Pemegang Polis"));
		firstHeaderCell3.setCellValue(new HSSFRichTextString("Cara Bayar"));
		firstHeaderCell4.setCellValue(new HSSFRichTextString("Bentuk Pembayaran"));
		firstHeaderCell5.setCellValue(new HSSFRichTextString("Tgl. Aktivasi(efektif Polis)"));
		firstHeaderCell6.setCellValue(new HSSFRichTextString("Status Polis"));
		firstHeaderCell7.setCellValue(new HSSFRichTextString("Tgl. Further Requirement"));
		firstHeaderCell8.setCellValue(new HSSFRichTextString("Kekurangan Data"));
		firstHeaderCell9.setCellValue(new HSSFRichTextString("User"));
		...
		sampleDataSheet.setColumnWidth((short) 3, (short)(4000));
		sampleDataSheet.setColumnWidth((short) 4, (short)(4000));
		sampleDataSheet.setColumnWidth((short) 5, (short)(5000));
		sampleDataSheet.setColumnWidth((short) 6, (short)(6000));
		sampleDataSheet.setColumnWidth((short) 7, (short)(5000));
		sampleDataSheet.setColumnWidth((short) 8, (short)(10000));
		sampleDataSheet.setColumnWidth((short) 9, (short)(6000));
		...
		// untuk isi row
		int row = 4;
		for(int i=0; i<reportFrMallAssurance.size(); i++) {
			HSSFRow dataRow1 = sampleDataSheet.createRow(row+i);
			dataRow1.createCell((short) 0).setCellValue(new HSSFRichTextString((i+1)+""));
			dataRow1.createCell((short) 1).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getNo_kartu()));
			dataRow1.createCell((short) 2).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getMsp_pas_nama_pp()));
			dataRow1.createCell((short) 3).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getMsp_up()));
			dataRow1.createCell((short) 4).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getMsp_text()));
			dataRow1.createCell((short) 5).setCellValue(new HSSFRichTextString(sdf.format(reportFrMallAssurance.get(i).getMsp_pas_create_date())));
			dataRow1.createCell((short) 6).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getStatus_polis()));
			dataRow1.createCell((short) 7).setCellValue(new HSSFRichTextString(sdf2.format(reportFrMallAssurance.get(i).getMsp_tgl_status())));
			dataRow1.createCell((short) 8).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getMsp_ket_status()));	
			dataRow1.createCell((short) 9).setCellValue(new HSSFRichTextString(reportFrMallAssurance.get(i).getMcl_first()));					
		}		
