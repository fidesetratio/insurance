...
public class Test1 {
	protected final static Log logger = LogFactory.getLog( Test1.class );
	DataSource dataSource;
	PlatformTransactionManager transactionManager;
	
	public Test1(String databaseName){
...
//		String[] daftarFile = new String[] {"D:/users/e-lion/mainRider2.txt"};
		//String[] daftarFile = new String[] {"D:/users/e-lion/MainReas/lost.txt"};
		//String[] daftarFile = new String[] {"D:/users/e-lion/MainReas/lost2.txt"};
		String[] daftarFile = new String[] {"D:/users/e-lion/MainReas/dd.txt"};
...
//			  	  		"?,?,?)",
				  koneksi.doInsert("insert into eka.mst_reins_product"+ 
						...
						new Object[] {
						  ...
						  rp.getMsrpr_end_date(),rp.getMsrpr_pemegang(),0,0,	rp.getMsrpr_premium(),
...
//			  			 rp.getMsrpr_prm_ext_risk(),rp.getMsrpr_comm_ext_risk(),rp.getMsrpr_contract_year()}
	...
	private static ComboPooledDataSource getDataSource(String databaseName){
		...
		try {
			...
			FileInputStream in = new FileInputStream(Resources.getResourceAsFile("jdbc.properties"));
			props.load(in);
