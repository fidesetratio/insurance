...
public class BankMayapada {

	private static BankMayapada instance;
	
	public static BankMayapada getInstance()
	{
		if( instance == null )
		{
			instance = new BankMayapada();
		}
		return instance;
	}
...
//	    			}
    			...
    			over.showTextAligned(Element.ALIGN_LEFT, FormatString.formatCurrency(krs, new BigDecimal(premi.doubleValue())) , x-338, y-553, 0);
