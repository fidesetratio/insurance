...
public class Lamp1VO implements Serializable
{
	private static final long serialVersionUID = -5962680485777736012L;
	String noUrutMemo;
    String hal;
    String tanggal;
    String spajNo;
    ...
    public void setLampiranList( List<Map<String, String>> lampiranList )
    {
	...
	public void setTempDescrDanJumlah(List<PreviewEditParamsVO> tempDescrDanJumlah) {
