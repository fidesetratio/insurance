...
public class GbrB2VO implements Serializable
{
	private static final long serialVersionUID = -5760046785928524233L;
	String noUrutMemo;
    String hal;
    String tanggal;
    String spajNo;
    ...
    String noVoucher;
    String ttd;
    String policyHolderAndInsuredName;
    String pembatal;
    String signer;
    String lca_id;
	...
	public String getPolicyHolderAndInsuredName() {
		return policyHolderAndInsuredName;
	}

	public void setPolicyHolderAndInsuredName(String policyHolderAndInsuredName) {
		this.policyHolderAndInsuredName = policyHolderAndInsuredName;
	}
}
