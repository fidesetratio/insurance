...
public class InputDbdPartnerController extends ParentFormController{
	...
	protected void onBindAndValidate(HttpServletRequest request, Object cmd, BindException err) throws Exception {
		...
		//pas.setPribadi(1);
		pas.setProduk(1);//DEMAM BERDARAH(BP)
		if(pas.getLsre_id() == 1){
...
//		schedulerPas();
		...
		return new ModelAndView(
        "uw/input_dbd_partner").addObject("cmd",pas);
