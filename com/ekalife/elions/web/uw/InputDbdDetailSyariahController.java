...
public class InputDbdDetailSyariahController extends ParentFormController{
	...
	protected void onBindAndValidate(HttpServletRequest request, Object cmd, BindException err) throws Exception {
		...
		if("DBD MALL".equals(pas.getJenis_pas())){
			if(!(umurTt>=1 && umurTt<=65)){ //batas umur 1 bulan s/d 60 tahun
				//cek bulan
				if(umurTt < 1){
					if(umurBlnTt < 1){
...
//		schedulerPas();
		...
		return new ModelAndView(
        "uw/input_dbd_detail_syariah").addObject("cmd",pas);
