...
public class StatusPasMallFormController extends ParentFormController{
...
//    }
	...
	protected ModelAndView onSubmit( HttpServletRequest request, HttpServletResponse response, Object cmd, BindException errors ) throws Exception
    {
		...
		try{
			...
			int x = uwManager.prosesStatusPasMallFormController(pas,request,errors, action);
			if(x == 1){
        ...
        "uw/status_pas_mall").addObject("cmd",pas);
	...
	protected Object formBackingObject(HttpServletRequest request)
		...
		String emailTo = "mallassurance@sinarmasmsiglife.co.id";
		//Stephanus Rudy, Underwriting Agency & Worksite
		String emailCc = "apriyani@sinarmasmsiglife.co.id;inge@sinarmasmsiglife.co.id;ningrum@sinarmasmsiglife.co.id";
