 ...
 * http://localhost/E-Lions/bas/kirim_promo.htm
 * 
 * (package com.ekalife.elions.web.bas)
 * @author Canpri
 * @since Feb 06, 2013 (10:21:23 AM)
 */
public class KirimPromoItemFormController extends ParentFormController {
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
		...
		return new ModelAndView(new RedirectView(request.getContextPath()+"/bas/kirim_promo.htm")).addObject("sukses", sukses);
	}
