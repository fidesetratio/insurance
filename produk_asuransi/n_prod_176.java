// 176 Power Save Bulanan Syariah
package produk_asuransi;

import com.ekalife.utils.f_hit_umur;

public class n_prod_176 extends n_prod {

	public n_prod_176()
	{
//		SK 
//		POWER SAVE Bulanan Syariah
		ii_bisnis_id = 176;
...
//		  untuk hitung end date ( 79 - issue_date )
		...
		flag_powersave = f_flag_rate_powersave(ii_bisnis_id, 1, 0);
		//isInvestasi = true;
...
//	get bisnis no
	...
	public void cek_flag_agen(int kode_produk, int no_produk, int flag_bulanan){
		...
		switch (no_produk)
		{
			case 1: // POWER SAVE BULANAN (I)
				flag_as = 0;
				isProductBancass = false;
				flag_worksite = 0;
				break;
			case 2: // POWER SAVE BULANAN (BA)
				flag_as = 0;
				isProductBancass = true;
				flag_worksite = 0;
				break;	
			case 3: //POWER SAVE BULANAN (AS)
				flag_as = 1;
				isProductBancass = false;
				flag_worksite = 0;
				break;
			case 4: //POWER SAVE BULANAN (C)
				flag_as = 0;
				isProductBancass = false;
				flag_worksite = 1;
				break;	
			case 5: //PLATINUMSAVE BULANAN
				flag_as = 0;
				isProductBancass = true;
				flag_worksite = 0;
				break;	
			case 6: //POWER SAVE BULANAN BANK Sinarmas
				flag_as = 0;
				isProductBancass = true;
				flag_worksite = 0;
				break;
			case 7: //POWER SAVE BULANAN KARYAWAN
				flag_as = 2;
				flag_worksite = 0;
				break;
			case 8: //Specta Bulanan
				flag_as = 0;
				flag_worksite = 0;
				break;
			case 9://SMART INVEST BULANAN
				flag_as = 0;
				flag_worksite = 0;
				break;
