// n_prod_107 FAST EXCELLINK SYARIAH
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_107 extends n_prod{
	Query query = new Query();
	public n_prod_107()
	{
//		fast excelink syariah
		ii_bisnis_id = 107;
...
//		   kombinasi[5] = "I"; // pp 20% - ptb 80%
	...
	public double of_get_rate()
	{
		...
		if (ii_bisnis_id >= 800)
		{
			...
			try {
				Double result = query.selectNilai(ii_jenis, 97, is_kurs_id, li_cp, li_lbayar, 10, ii_tahun_ke, ii_age);
