 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_803 extends n_prod{
...
//	of_set_usia_tt
	...
	public String of_check_usia_rider(int tahun1, int bulan1, int tanggal1,int tahun2, int bulan2, int tanggal2,int lm_byr,int nomor_produk, int nomor_rider) 
	{
		...
		switch (li_lbayar)
		{
			case 5:
				if (ii_usia_tt  < 20)
				{
					hsl="Usia Masuk  untuk Term minimum : 20 tahun";
				}
				if (ii_usia_tt > 55)
				{
					hsl="Usia Masuk  untuk Term maximum : 55 tahun";
				}	
				break;		
			case 10:
				if (ii_usia_tt  < 20)
				...
				if (ii_usia_tt > 60)
				{
					hsl="Usia Masuk  untuk Term maximum : 60 tahun";
				}	
				break;	
			case 15:
				if (ii_usia_tt  < 20)
			...
			case 18:
				...
				if (ii_usia_tt > 52)
				{
					hsl="Usia Masuk  untuk Term maximum : 52 tahun";
				}	
				break;	
			case 20:
				if (ii_usia_tt  < 20)
				...
				if (ii_usia_tt > 50)
				{
					hsl="Usia Masuk  untuk Term maximum : 50 tahun";
				}	
				break;																		
		}
	...
	public double of_get_rate1( int li_class, int flag_jenis_plan, int nomor_bisnis, int umurttg, int umurpp)
	{
		...
		rate_rider=0;
		try {
			Double result = query.selectNilai(1, 803, is_kurs_id, ii_pmode, li_lbayar, li_lbayar, 1, ii_usia_tt);
			if(result != null) {
