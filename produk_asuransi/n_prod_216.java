 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_216 extends n_prod{
...
//			hasil_up="";
	...
	public String min_total_premi(Integer pmode_id, double premi , String kurs)
	{
		...
		if(kurs.equalsIgnoreCase("01"))
		{
			...
			case 1:
				...
				{
					hsl="Minimum Premi Pokok Triwulanan (3 bulanan ) : Rp. 1.350.000,-";
				}
				break;
			case 2:
				if (total_premi < 2625000)
				{
					hsl="Minimum Premi Pokok Semesteran (6 bulanan ) : Rp. 2.625.000,-";
				}
				break;
			case 3:
				if (total_premi < 5000000)
				{
					hsl="Minimum Premi Pokok Tahunan : Rp. 5.000.000.-";
				}
				break;
			case 6:
				if (total_premi < 500000)
				{
					hsl="Minimum Premi Pokok Bulanan (1 bulanan) : Rp. 500.000,-";
				}
				break;
			}
			...
			case 1:
				if (total_premi < 135)
				{
					hsl="Minimum Premi Pokok Triwulanan (3 bulanan ) : US$. 135,-";
				}
				break;
			case 2:
				if (total_premi < 262)
				{
					hsl="Minimum Premi Pokok Semesteran (6 bulanan ) : US$. 262,-";
				}
				break;
			case 3:
				if (total_premi < 500)
				{
					hsl="Minimum Premi Pokok Tahunan : US$. 500.-";
				}
				break;
			case 6:
				if (total_premi < 50)
				{
					hsl="Minimum Premi Pokok Bulanan (1 bulanan) : US$. 50,-";
				}
				break;
			}
		}
	...
	public String of_check_usia(int tahun1, int bulan1, int tanggal1,int tahun2, int bulan2, int tanggal2,int lm_byr,int nomor_produk) 
	{
		...
		if (ii_usia_pp > 85)
		{
			hsl="Usia Pemegang Polis Maksimum : 85 Tahun !!!";
		}
