 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_183 extends n_prod{
	...
	public n_prod_183()
	{
		...
		indeks_ii_lama_bayar = 149; // [141424] - Nana 135 to 149
		...
		ii_lama_bayar[132] = 1;
		ii_lama_bayar[133] = 1;
		ii_lama_bayar[134] = 1;	// nana begin 135
		ii_lama_bayar[135] = 1;	// nana begin 136
		ii_lama_bayar[136] = 1;	// nana begin 137
		ii_lama_bayar[137] = 1;	// nana begin 138
		ii_lama_bayar[138] = 1;	// nana begin 139
		ii_lama_bayar[139] = 1;	// nana begin 140
		ii_lama_bayar[140] = 1;	// nana begin 141
		ii_lama_bayar[141] = 1;	// nana begin 142
		ii_lama_bayar[142] = 1;	// nana begin 143
		ii_lama_bayar[143] = 1;	// nana begin 144
		ii_lama_bayar[144] = 1;	// nana begin 145
		ii_lama_bayar[145] = 1;	// nana begin 146
		ii_lama_bayar[146] = 1;	// nana begin 147
		ii_lama_bayar[147] = 1;	// nana begin 148
		ii_lama_bayar[148] = 1;	// nana begin 149
	...
	public String of_alert_min_up( double up1)
	{
		...
		if(ii_bisnis_no<=120){
			...
			if(ii_bisnis_no==121 || ii_bisnis_no == 133){//plan P
				idec_up = 5000000;
			}else if(ii_bisnis_no==122 || ii_bisnis_no == 134){//plan Q
				idec_up = 7500000;
			}else if(ii_bisnis_no>= 135 && ii_bisnis_no <= 149){
				if(ii_bisnis_no == 135){
					idec_up = 100000;
				} else if (ii_bisnis_no == 136){          // [141424] - nana SMCP B
					idec_up = 150000;
				} else if (ii_bisnis_no == 137){          // nana SMCP C
					idec_up = 200000;
				} else if (ii_bisnis_no == 138){          // nana SMCP D
					idec_up = 250000;
				} else if (ii_bisnis_no == 139){		  // nana SMCP E
					idec_up = 300000;
				} else if (ii_bisnis_no == 140){          // nana SMCP F
					idec_up = 350000;
				} else if (ii_bisnis_no == 141){          // nana SMCP G
					idec_up = 400000;
				} else if (ii_bisnis_no == 142){		  // nana SMCP H
					idec_up = 500000;
				} else if (ii_bisnis_no == 143){          // nana SMCP I
					idec_up = 600000;
				} else if (ii_bisnis_no == 144){		  // nana SMCP J
					idec_up = 700000;
				} else if (ii_bisnis_no == 145){		  // nana SMCP K
					idec_up = 800000;
				} else if (ii_bisnis_no == 146){		  // nana SMCP L
					idec_up = 900000;
				} else if (ii_bisnis_no == 147){          // nana SMCP M
					idec_up = 1000000;
				} else if (ii_bisnis_no == 148){          // nana SMCP N
					idec_up = 1500000;
				} else if (ii_bisnis_no == 149){		  // [141424] - nana SMCP O
					idec_up = 2000000;
				}
			}
		};
		...
		if(is_kurs_id.equalsIgnoreCase("01")){
			if(ii_bisnis_no<=120){
				...
				if(ii_bisnis_no==121 || ii_bisnis_no == 133){//plan P
					...
					if(ii_bisnis_no == 135){
						idec_up = 100000;
					} else if (ii_bisnis_no == 136){          // nana SMCP B
						idec_up = 150000;
					} else if (ii_bisnis_no == 137){          // nana SMCP C
						idec_up = 200000;
					} else if (ii_bisnis_no == 138){          // nana SMCP D
						...
						idec_up = 1500000;
					} else if (ii_bisnis_no == 149){		  // nana SMCP O
						idec_up = 2000000;
					}
				}
			}
	...
	public void of_hit_premi()
	{
		...
		try{
			Integer bisnis_no = ii_bisnis_no;
			if(ii_bisnis_no >= 91 && ii_bisnis_no <= 105){
				bisnis_no = bisnis_no - 60;
			}else if((ii_bisnis_no >= 106 && ii_bisnis_no <= 120) ){
				bisnis_no = bisnis_no - 30;
			}else if((ii_bisnis_no >= 121 && ii_bisnis_no <= 122) || (ii_bisnis_no >= 133 && ii_bisnis_no <= 134)){
				bisnis_no = ii_bisnis_no;
			}
			Double result = query.selectPremiSuperSehat(ii_bisnis_id, bisnis_no, ii_age, is_kurs_id);
			...
			if(ii_bisnis_no<=120){
				...
				if(ii_bisnis_no==121){//plan P
					idec_up = 5000000;
				}else if(ii_bisnis_no==122){//plan Q
					idec_up = 7500000;
				}else if(ii_bisnis_no>= 135 && ii_bisnis_no <= 149){
					if(ii_bisnis_no == 135){
						idec_up = 100000;
