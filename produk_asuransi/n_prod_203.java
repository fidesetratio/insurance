 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_203 extends n_prod{
...
//
	...
	public void of_set_premi(double adec_premi)	{
		if(ii_bisnis_no == 4) adec_premi = 150000.0;
...
//		idec_premi = 346000; 
	...
	public String of_alert_min_up( double up1)
	{
		...
		if(ii_bisnis_no == 4){
			if(up1 != Double.valueOf(4500000)){
				hasil_min_up = " UP untuk plan ini harus Rp. 4.500.000,-";
			}
		}
...
//	cek usia	
	public String of_check_usia(int tahun1, int bulan1, int tanggal1,int tahun2, int bulan2, int tanggal2,int lm_byr,int nomor_produk) 
	{
		...
		if (nomor_produk <= 4)
		{
			...
			if (nomor_produk == 4 && bln < 1) 
			{
				hsl="Usia Masuk Plan ini minimum : 1 Bulan";
			}
			else if (bln < 6)
			{
