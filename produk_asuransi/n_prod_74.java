 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_74 extends n_prod{
	long ll_premi;
...
//
	...
	public boolean of_check_premi(double ad_premi)
	{
		...
		{
			case 3:
				if (ad_premi < 3000000 ) return false;
				break;
			case 2:	
				if (ad_premi < 2000000) return false;
				break;
			case 1:
				if (ad_premi < 1500000) return false;
				break;
		}
		...
		{
			case 1:
				if (ad_premi > 15000000) return false;
				break;
			case 2:
				if (ad_premi < 15000000 || ad_premi > 75000000) return false;
				break;
			case 3:
				if (ad_premi < 75000000) return false;
				break;
		}
		return true;
	}
