 ...
 */
public class n_prod_186 extends n_prod{
...
//				ldec_1 = new Double(2000000/4); 
				ldec_1 = new Double(500000);
			}else{
				if (ii_pmode == 2)
				{
					//semesteran
//					ldec_1 = new Double(2000000/2); 
					ldec_1 = new Double(1000000); 
				}else{
					if (ii_pmode == 6)
					{
						//bulanan
//						ldec_1 = new Double(2000000/12); 
						if(ii_bisnis_no==3){
							ldec_1 = new Double(400000);
						}else{
							ldec_1 = new Double(200000);
						}
...
//	get rate
	...
	public void of_set_bisnis_no(int ai_no) {
		ii_bisnis_no = ai_no;
		li_pmode_list = new int[indeks_li_pmode];
		indeks_li_pmode = 5;
		if(ii_bisnis_no==3){
			...
			li_pmode[1] = 3 ;  //tahunan
			li_pmode[2] = 2 ;  //semester
			li_pmode[3] = 1 ;  //Tri
			li_pmode[4] = 6 ;  //Bulanan
			ii_pmode_list = li_pmode;
		}
...
// of_set_kurs
	...
	public void of_set_premi(double adec_premi)
	{
		...
		if(idec_up>new Double(10000000)){
			idec_up = new Double(10000000);
		}else{
			idec_up = idec_up;
		}
...
//			 }
	...
	public String cek_min_up(Double premi, Double up, String kurs , Integer pmode_id)
	{
		...
		min_up1=idec_up;
		min_up2 = 500 * premi.doubleValue() /100;
	...
	public String min_total_premi(Integer pmode_id, double premi , String kurs)
	{
		...
		if(pmode_id==2){
			total_premi = new Double(total_premi * 2);
		}else if(pmode_id==1){
			total_premi = new Double(total_premi * 4);
		}else if(pmode_id==6){
			total_premi = new Double(total_premi * 12);
		}
		if(ii_bisnis_no<3){
			if(kurs.equalsIgnoreCase("01"))
			{
				if (total_premi < 2000000)
					{
						hsl="Minimum Total Premi : Rp. 2.000.000,-";
					}
			}else{
				if (total_premi < 200)
					{
						hsl="Minimum Total Premi : US$ 200";
					}
			}
		}else if(ii_bisnis_no==3){
			if(kurs.equalsIgnoreCase("01"))
			{
				double modulus400rb = premi%400000;
				if (total_premi < 4800000 || modulus400rb!=0)
					{
						hsl="Minimum Total Premi Tahunan: Rp. 4.800.000,- dan Premi harus kelipatan Rp. 400.000,-";
					}
			}else{
				double modulus40 = premi%40;
				if (total_premi < 480 || modulus40!=0)
					{
						hsl="Minimum Total Premi Tahunan: US$ 480 dan Premi harus kelipatan US $40";
					}
			}
		}
	return hsl;
	...
	public String min_topup(Integer pmode_id, double premi , double premi_topup, String kurs, int jenis_topup)
	{
		...
		if(ii_bisnis_no<3){
			...
			if(kurs.equalsIgnoreCase("01"))
			{
				if (total_premi < 4800000)
					{
						hsl="Minimum Total Premi Tahunan: Rp. 4.800.000,-";
					}
			}else{
				if (total_premi < 480)
					{
						hsl="Minimum Total Premi Tahunan: US$ 480";
					}
			}
		}
