 ...
 */
public class n_prod_199 extends n_prod{
...
//		ib_flag_end_age = False
		...
		indeks_idec_pct_list=7; // faktor lscb_no
		...
		if (kurs.equalsIgnoreCase("01"))
		{
			switch (pmode_id.intValue())
			{
				...
				case 6:
					...
					{
						hsl="Minimum Total Premi Bulanan (1 bulanan) : Rp. 100.000,00";
					}
					break;
			}
		}
