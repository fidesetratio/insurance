 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_804 extends n_prod{
...
//	of_set_usia_tt
	...
	public String of_check_usia_rider(int tahun1, int bulan1, int tanggal1,int tahun2, int bulan2, int tanggal2,int lm_byr,int nomor_produk, int nomor_rider) 
	{
		...
		{
			hsl="Usia Masuk  untuk WPD minimum : " + ii_age_from +" tahun";
		}
		if (ii_usia_tt > ii_age_to)
		{
			hsl="Usia Masuk  untuk WPD maximum : " + ii_age_to +" tahun";
		}
		return hsl;		
	}	
	...
	public double of_get_rate1( int li_class, int flag_jenis_plan, int nomor_bisnis, int umurttg, int umurpp)
	{
		...
		rate_rider=0;
		try {
			Double result = query.selectNilai(1, 804, is_kurs_id, ii_pmode, li_lbayar, li_lbayar, 1, umurttg);
			if(result != null) {
	...
	/**
	 * Yusuf (10/04/08) UP rider = PREMI plan pokok
	 */
	...
	public String cek_hubungan(String hub)
	{
		...
		{
			hsl="Khusus rider ini , hubungan pemegang polis dengan tertanggung adalah diri sendiri";
		}
		return hsl;
	}
