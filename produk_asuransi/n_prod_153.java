//n_prod_153 Excellink 80 plus syariah
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_153 extends n_prod{
...
//		   kombinasi[5] = "I"; // pp 20% - ptb 80%
	...
	public double of_get_min_up()//SK No. 053/EL-SK/VI/2006
	{
		double ldec_1=0;
		...
		if (ii_bisnis_no == 5) {
			ldec_1 = 410000;
		}else if (is_kurs_id.equalsIgnoreCase("01")){ //rupiah
			if (ii_pmode==0){
				ldec_1 =5000000; 
			}else if (ii_pmode==3){
				ldec_1 =1800000; 
...
//	get rate
	...
	public void of_set_bisnis_no(int ai_no)
	{
		...
		if (ii_bisnis_id < 800){
			if (ai_no == 1 || ai_no == 3 || ai_no == 6){
				indeks_li_pmode=2;
				li_pmode[1] = 0;
			}else if (ai_no == 5){ //muamalat - mabrur
				indeks_li_pmode=2;
				li_pmode[1] = 6;
...
//	of_set_kurs
	...
	public void of_set_premi(double adec_premi)
	{
		...
		{
			idec_rate = 5000;
		} else if (ii_bisnis_no == 4 || ii_bisnis_no == 7){ //helpdesk [142338] Perubahan minimum UP produk reguler premium UL Agency
			idec_rate = 10000;
		}
		...
		//hitung UP / TSI
		if(ii_bisnis_no == 5) { //muamalat - mabrur
			idec_up = 40000000; //up fix 40 juta
		}else {
...
/*	public String cek_min_up(Double premi, Double up, String kurs, Integer pmode_id)
	...
	public String cek_min_up(Double premi, Double up, String kurs , Integer pmode_id)//SK No. 053/EL-SK/VI/2006
	{
		String hasil_up="";
		double min_up1=0;
		double min_up2=0;
		...
		if (ii_bisnis_no == 4 || ii_bisnis_no == 7){ //helpdesk [142338] Perubahan minimum UP produk reguler premium UL Agency
			rate1 = 1000;
			rate2 = 10;
		}
	...
	public String cek_max_up(Integer li_umur_ttg, Integer kode_produk, Double premi, Double up, Double fltpersen, Integer pmode_id,String kurs)
	{
		...
		if (li_umur_ttg.intValue() < 6)
		{
			...
			try {
				Integer umrTertanggung=li_umur_ttg;
				if(umrTertanggung>=65){
					umrTertanggung=65;
				}
				Integer result = query.faktorexcell80(umrTertanggung.intValue(),153);
	...
	public String min_total_premi(Integer pmode_id, double premi , String kurs)
	{
		...
		if(kurs.equalsIgnoreCase("01"))
		{
			switch (pmode_id.intValue())//SK No. 053/EL-SK/VI/2006
			{
				case 0:
