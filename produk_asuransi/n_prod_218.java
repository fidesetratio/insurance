//n_prod_218 SMiLe LINK 100 SYARIAH
 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_218 extends n_prod{
...
//		ii_rider[x++]=819;		//15.	SMiLe Hospital Protection PROTECTION FAMILY 
		...
		ii_rider[x++]=833;		//17.	SMiLe LADIES MEDICAL IL
	...
	public String of_check_usia(int tahun1, int bulan1, int tanggal1,int tahun2, int bulan2, int tanggal2,int lm_byr,int nomor_produk) 
	{
		...
		if (lm_byr < 5)
		{
			hsl="Untuk produk SMiLe Link Pro 100 Syariah, minimal masa Pembayaran yg diperbolehkan adalah 5 Tahun !!!";
		}
