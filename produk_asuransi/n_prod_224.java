...
/**
 * @author Randy - 001 SMiLe LINK PRO SYARIAH (BTN)
 *
 * To change the template for this generated type comment go to
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_224 extends n_prod{
...
//	}
	...
	public String of_alert_min_premi( double premi)
	{
		double min_premi = 0;
		if (ii_bisnis_no==2
			|| ii_bisnis_no==3	) { //helpdesk [133899], produk B Smile Protection Syariah 224-3
		...
		if (min_premi > premi)
		{
			hasil_min_premi=" Premi Minimum untuk plan ini : "+ f.format(min_premi);	
		}
