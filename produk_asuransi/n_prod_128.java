 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class n_prod_128 extends n_prod {
...
//				idec_rate = 0.5;
	...
	{
		boolean hsl=true;
		if(ii_bisnis_no==7 || ii_bisnis_no==8 || ii_bisnis_no==9 || ii_bisnis_no==10){//product excelink
	...
	{
		double ldec_1=0;
		if(ii_bisnis_no==7 || ii_bisnis_no==8 || ii_bisnis_no==9 || ii_bisnis_no==10){//*excellink
			if (is_kurs_id.equalsIgnoreCase("01")){
			switch (ii_pmode)
			{
				case 3:
