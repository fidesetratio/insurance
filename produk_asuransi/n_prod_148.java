 ...
 */
public class n_prod_148 extends n_prod {
...
//		1..4 cuma id, 0..3 di lst_cara_bayar
		...
		ii_pmode_list[2] = 3; //tahunan (12 x bulanan)
		ii_pmode_list[3] = 2; //semesteran (6 x bulanan)
		ii_pmode_list[4] = 1; //triwulanan (3 x bulanan)
			...
			Double result = query.selectPremiSuperSehat(ii_bisnis_id, ii_bisnis_no, ii_age, is_kurs_id);
			 ...
			 if(result != null) {
				...
				if (ii_pmode == 6) { //bulanan
					...
					idec_premi = idec_premi * 0.1 * 12;
				}else if (ii_pmode == 2) { //semesteran
					idec_premi = idec_premi * 0.1 * 6;
				}else if (ii_pmode == 1) { //triwulanan
					idec_premi = idec_premi * 0.1 * 4;
				}
